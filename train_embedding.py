...
a = input_data.AudioDataset(model_settings, commands, bg_datadir, [], unknown_percentage=0, spec_aug_params=input_data.SpecAugParams(percentage=80))
...
checkpoint_filepath="rw_165commands_efficientnet_selu_specaug80.{epoch:03d}-{val_accuracy:.4f}"
